...
def improvedStaticEstimation(input):
    black = 0
    white = 0
...
def MaxMin(input, depth):
    ...
    if depth == 0:
        ...
        for i in l:
            ...
            if x < improvedStaticEstimation(minBoard):
                x = improvedStaticEstimation(minBoard)
                estimate = x
                maxC = i
        return maxC
    return input
...
def MinMax(input, depth):
    ...
    if depth == 0:
        ...
        for i in l:
            ...
            if posX > improvedStaticEstimation(maxBoard):
                posX = improvedStaticEstimation(maxBoard)
                minC = i
        return minC
    return input
